...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-white to-amber-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal direction="left">
              <div className="hidden lg:block">
                ...
                {/* Loyalty teaser */}
                <div className="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border border-amber-200 dark:border-amber-700/50 rounded-2xl p-6">
                  <div className="flex items-center mb-3">
                    <Gift className="h-6 w-6 text-amber-600 mr-2" />
                    <h3 className="font-heading font-semibold text-gray-900 dark:text-white text-lg">Amaluna Rewards</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center">
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-3">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">per LKR 100</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-3">
                      <div className="text-2xl font-bold text-amber-600">500</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">sign-up bonus</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-3">
                      <div className="text-2xl font-bold text-amber-600">2x</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">birthday points</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <ScrollReveal direction="right">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-luxury-lg dark:shadow-gray-900/50 p-8 md:p-10">
                {/* Mobile heading */}
                <div className="lg:hidden text-center mb-6">
                  <h1 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">Welcome Back</h1>
                </div>
                ...
                {activeTab === 'login' && (
                  <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                      <label className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                        <input
                          ...
                          className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 dark:border-gray-600 rounded mr-2"
                        />
                        Remember me
                      </label>
                      <button type="button" className="text-sm text-amber-600 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-300 font-medium">
                        Forgot password?
                      </button>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button type="button" className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="flex items-start">
                      <input
                        ...
                        className="mt-1 h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 dark:border-gray-600 rounded"
                      />
                      <label className="ml-2 text-sm text-gray-600 dark:text-gray-400">
                        I agree to the <a href="/terms" className="text-amber-600 hover:underline dark:text-amber-400">Terms & Conditions</a> and{' '}
                        <a href="/privacy-policy" className="text-amber-600 hover:underline dark:text-amber-400">Privacy Policy</a>.
                      </label>
                    </div>
